...
class UpdateScheduleFrame(ttk.Frame):
    ...
    def createLeftFrame(self):
        ...
        open_file_button = ttk.Button(left_frame, text='파일 불러오기', command=self.openExcelToUpdate)
        ...
        # Start button
        submit_button = ttk.Button(left_frame, text='시작', command=self.updateSchedule)
